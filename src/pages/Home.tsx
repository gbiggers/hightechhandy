          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-2xl text-foreground font-ovo leading-relaxed">
                Hi 👋 I'm Greg, your friendly high tech handyman. I solve technology challenges with phones, computers, TVs, and Wi-Fi. Let's make tech work for you and your family, not against you. Whether setting up something new or existing problems, I can help.
