...
const Home = () => {
  return <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-8 pl-3 pr-6 sm:px-4">
...
Whether setting up something new or solving existing problems, I can help.
      ...
      {/* Services Section */}
      <section className="py-8 pl-3 pr-6 sm:px-4 bg-muted/30">
        <div className="container mx-auto">
      ...
      {/* CTA Section */}
      <section className="py-12 pl-3 pr-6 sm:px-4">
        <div className="container mx-auto">
...
Use the button below to text Greg:
      ...
      {/* Footer */}
      <footer className="py-8 pl-3 pr-6 sm:px-4 border-t border-border">
